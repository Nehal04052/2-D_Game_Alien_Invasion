...
class AlienInvasion:
    #class to manage the resources and behaviour.
    ...
    def _create_fleet(self):
        ...
        #spacing between each line is equal to one alien width.
...
if __name__=='__main__':
    #Make a game object or instance,and run the game
